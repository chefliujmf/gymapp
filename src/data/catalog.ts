...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    carbs: 62,
    fat: 14,
    ingredients: ['180g chicken breast', '1 cup cooked brown rice', '1 cup roasted veg', 'Avocado, 1/4', 'Olive oil, lemon, paprika'],
    steps: ['Season and pan-sear chicken until cooked through.', 'Warm rice and roasted veg.', 'Slice chicken, assemble bowl, finish with avocado and lemon.'],
  ...
  },
  {
    ...
    carbs: 22,
    fat: 28,
    ingredients: ['1 salmon fillet', 'Broccoli & asparagus', 'Sweet potato, 1 small', 'Garlic, olive oil, dill'],
    steps: ['Roast sweet potato 25 min at 200°C.', 'Add salmon and greens for the last 12–15 min.', 'Finish with dill and a squeeze of lemon.'],
