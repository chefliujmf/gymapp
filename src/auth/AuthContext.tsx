...
export function Gate({ children }: { children: ReactNode }) {
  ...
  if (loading) return <div className="auth-splash"><div className="auth-logo"><img src="/favicon.svg?v=6" alt="" style={{ width: 40, height: 40, borderRadius: 10, verticalAlign: '-9px', marginRight: 9 }} />platy<span style={{ color: 'var(--accent)' }}>plus</span></div></div>
