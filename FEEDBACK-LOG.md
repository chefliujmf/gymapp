...
706. ⬜ **Calendar: 07-27 and 08-03 gym have the SAME title + almost the same exercises (JM 2026-07-22, "can be fine but audit this to be sure").** Audit whether the coach generates repetitive gym sessions week-to-week (same title, same exercise selection) — variety should rotate (archetypes/accessory rotation exist; verify they actually apply across weeks for gym). **Route:** gym session titling (sessionTitle) + assembler rotation + the coach's week-to-week variety; check the real 07-27/08-03 plans.
