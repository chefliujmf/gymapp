...
66. ⬜ **Week-strip: dot on days that have something** — show a little indicator under each day in the WeekStrip when that day has a plan/activity/item, so you can see at a glance which days are populated.
