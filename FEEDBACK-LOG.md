...
**★ EXERCISE CATALOG AUDIT (JM 2026-07-21 "full audit on the exercises") — running as a sub-task; findings to be logged as #647+ (equipment mis-tags like goblet squat=Bodyweight, band-only coverage gaps, dup/L-R split names, missing media, timed-mode hints).**
