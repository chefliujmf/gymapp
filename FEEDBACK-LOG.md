...
716. ⬜ **[audit#6] Triathlete collapses to bike-only in 3 code layers (['triathlon'] matches no sport).** Make archetype/buildSystemPrompt/weekShape triathlon-aware: per-discipline archetypes, all 3 focus lists, ~1 quality/discipline, clamp lowest-priority discipline. Route: archetypes.js + server.js + week-shape.js.
