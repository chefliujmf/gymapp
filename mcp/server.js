...
server.tool('set_activity_text',
  'Set the PUBLIC title + description on a COMPLETED intervals activity (this SYNCS TO STRAVA and is visible to others). PUBLIC-SAFE ONLY: no score, health/pain/niggles, fatigue/recovery status, feelings ("felt good so I…"), or future-plan protection (those go in save_coach_review, the private Notes thread). TWO DIFFERENT VOICES: the TITLE is HUMAN + creative, a normal athlete Strava title (route, session type, a segment/KOM/Local Legend, keep it fun, e.g. "KOM on the Backroads" or "Another Local Legend, Relaxed Miles"); the DESCRIPTION is CLEAR + PLAIN (the audience are fit people, NOT scientists), one or two everyday sentences naming the zone (Z1 to Z5), the effort, and what it was FOR (base, engine, endurance, comfortably hard, threshold) with the numbers (avg power, duration), e.g. "Steady Z2 endurance ride, 71 min at 153 W, easy aerobic pace building your base". Do NOT lecture physiology (no "mitochondrial density", "fat oxidation", "lactate", "excursions") and no cocky filler ("relaxing spin", "classic spin", "snagged a Local Legend"). NEVER use an em-dash in either field, use commas or periods. Follow instructions_public_text.',
